...
const UpskillingWelcome = () => {
    ...
    const [accessLoading, setAccessLoading] = useState(true); // ✅ Added loading state
    const [hasAccess, setHasAccess] = useState(false); // ✅ Added access state
    ...
    const startUpskilling = async (initialSkill = null) => {
        console.log('🚀 Starting upskilling...');
        ...
        try {
            ...
            if (data.hasAccess) {
                console.log('✅ Access granted - navigating to upskilling');
                if (initialSkill) {
